...
class PeerIntegrationTest {
    ...
    private PeerController createPeer(String username, int port) throws Exception {
        return new PeerController(username, port, "localhost", BOOTSTRAP_PORT, HEARTBEAT_PORT);
    }
    ...
    void testMultipleMessagesOrdering() throws Exception {
        ...
        try {
            ...
            // Verify ordering: each message's clock should happen-before or equal to the
            // next
