...
class GroupChatIntegrationTest {
    ...
    void testMinimumGroupSize() throws Exception {
        ...
        assertThrows(IllegalArgumentException.class, () -> alice.createGroup("SmallGroup", List.of("Bob")),
                "Creating a group with a single invitation should throw");
    }
    ...
    void testConsensusSync() throws Exception {
        ...
        MultiPeerGroupEventWaiter restoredMessageWaiter = new MultiPeerGroupEventWaiter(groupId,
                TestEvent.MESSAGE_RECEIVED,
                restoredGroup);
    ...
    void testMemberLeavingContinuesGroup() throws Exception {
        ...
        // This prevents the gossip manager from detecting leader failure during the
        // test
    ...
    void testMessagesNotDeliveredAfterLeave() throws Exception {
        ...
        MultiPeerGroupEventWaiter messageWaiter = new MultiPeerGroupEventWaiter(groupId, TestEvent.MESSAGE_RECEIVED,
                remainingPeers);
    ...
    void testLeaderElectionExcludesLeftUsers() throws Exception {
        ...
        // Now Alice (leader) stops - this should trigger election among Bob, Charlie,
        // David
        alice.stop();
        peers.remove(alice);
        ...
        // Wait for election
        List<PeerController> remainingPeers = List.of(bob, charlie, david);
        MultiPeerGroupEventWaiter electionWaiter = new MultiPeerGroupEventWaiter(groupId, TestEvent.LEADER_ELECTED,
                remainingPeers);
