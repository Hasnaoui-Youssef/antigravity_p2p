...
class CausalDeliveryManagerTest {
    ...
    private static final String LOCAL_PROCESS = "local";
    private static final String PROCESS_A = "processA";
    private static final String PROCESS_B = "processB";
    private static final String PROCESS_C = "processC";

    @BeforeEach
    void setUp() {
        VectorClock localClock = new VectorClock();
        manager = new CausalDeliveryManager(LOCAL_PROCESS, localClock);
    }
    ...
    void testMultipleSendersInterleaved() {
        ...
        // Deliver in order: A3 (buffer), B2 (buffer), A1 (deliver), B1 (deliver + triggers B2)
