...
public class TerminalUI {
    ...
    public TerminalUI(PeerController controller, String bootstrapHost, int bootstrapPort) {
    ...
    private void commandLogin() throws Exception {
        ...
        bootstrapService.register(controller.getLocalUser());
    ...
    private void commandQuit() throws Exception {
        if (bootstrapService != null) {
            bootstrapService.unregister(controller.getLocalUser().getUserId());
        }
        running = false;
