...
public final class GossipMessage extends Message {
    ...
    public GossipMessage(String messageId, String senderId, String senderUsername, String groupId, long timestamp, VectorClock vectorClock, Map<String, Long> leaderLastSeen) {
        ...
        this.leaderLastSeen = leaderLastSeen != null ? 
            Collections.unmodifiableMap(new HashMap<>(leaderLastSeen)) : 
    ...
    public static GossipMessage create(User sender, String groupId, VectorClock clock, Map<String, Long> leaderLastSeen) {
        return new GossipMessage(
            UUID.randomUUID().toString(),
            sender.getUserId(),
            sender.getUsername(),
